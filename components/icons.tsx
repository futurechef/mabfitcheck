...
export const LayersIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.1 6.31a2 2 0 0 0 0 3.65L11.17 14.1a2 2 0 0 0 1.66 0L21.9 9.96a2 2 0 0 0 0-3.65L12.83 2.18Z" />
    <path d="m2.1 14.31 9.07 4.13a2 2 0 0 0 1.66 0l9.07-4.13" />
    <path d="m2.1 10.31 9.07 4.13a2 2 0 0 0 1.66 0l9.07-4.13" />
  </svg>
);
